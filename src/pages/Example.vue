<template lang='pug'>
  .page
    .container
      h1#main Cradle test page
      p The purpose of this HTML is to help determine what default settings are with Cradle.
      p
        router-link(to="HelloWorld") Back to HelloWorld.
      hr
      ...
      h6 h6. Heading
      hr
      h1#paragraph Paragraph
      p Lorem ipsum dolor sit amet,
        a(href='#', title='test link') test link
      ...
      h3 %default-ol Ordered List
      ol.default
        li List Item 1
        li List Item 2
        li List Item 3
        h3 %default-ul Unordered List
        ul.default
        li List Item 1
        li List Item 2
        li List Item 3
      ...
      h1#form_elements Fieldsets and Form Elements
      fieldset
        p
        ...
        form
          ...
          select(name='select_element')
            ...
            optgroup(label='Option Group 2')
              ...
              option(value='3') Option 3
            p
              label(for='radio_buttons') Radio Buttons:
            label
            ...
            label
              ...
              | Radio 3
            p
              label(for='checkboxes') Checkboxes:
            label
